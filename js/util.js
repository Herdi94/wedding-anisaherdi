...
export const util = (() => {
    ...
    const guest = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 color-theme-white" style="font-size: 0.9rem;">${guest.getAttribute('data-message')}</p><h2 class="color-theme-white" style="font-size: 0.9rem;">${escapeHtml(name)}</h2>`;
